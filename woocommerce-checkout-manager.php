...
function wccs_custom_checkout_field( $fields ) {
...
$fields['billing']['billing_'.$btn['label'].''] = array(
        'label'     => __(''.$btn['label'].'', 'woocommerce'),
    'placeholder'   => _x(''.$btn['placeholder'].'', 'placeholder', 'woocommerce'),
...
add_filter( 'woocommerce_checkout_fields', 'wccs_custom_checkout_field');